...
class _AirportAppState extends State<AirportApp> {
  ...
  void initState() {
    ...
    ThemePreferences.load().then((pref) {
      ...
      setState(() {
        ...
        _scope.themeMode = pref == AppThemePreference.dark ? ThemeMode.dark : ThemeMode.light;
  ...
  Future<void> _toggleTheme() async {
    ...
    final next = _scope.themeMode == ThemeMode.dark ? ThemeMode.light : ThemeMode.dark;

    setState(() => _scope.themeMode = next);

    await ThemePreferences.save(

      next == ThemeMode.dark ? AppThemePreference.dark : AppThemePreference.light,
